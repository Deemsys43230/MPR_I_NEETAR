...
//        NotificationCenter.default.removeObserver(self)
    ...
    @IBAction func showAlphabet(_ sender: UIButton) {
        // Firebase events
        Analytics.logEvent("Menu_Tapped_iOS", parameters: nil)
    ...
    @objc  func startUnity() {
        ...
        if self.cameraButton != nil, let topController = UIApplication.topViewController(), !(topController is augmentViewController){
            self.cameraButton.isHidden = true
            self.speakerButton.isHidden = true
